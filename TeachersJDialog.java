...
public class TeachersJDialog extends javax.swing.JDialog {
    ...
    public void setForm(Teachers te) {        
        ...
        txtName.setText(te.getFullname());
        txtDate.setText(String.valueOf(te.getBirthdate()));
        txtMail.setText(te.getGmail());
        cboDeparts.setSelectedItem(te.getDepartment());
    ...
    public Teachers getForm() {
        ...
        teach.setFullname(txtName.getText());
        teach.setPhoto(img);
        teach.setBirthdate(XDate.parse(txtDate.getText()));        
        teach.setGmail(txtMail.getText());
        teach.setDepartment(String.valueOf(cboDeparts.getSelectedItem()));
        return teach;
    }
    ...
    private void initComponents() {
        ...
        cboDeparts = new javax.swing.JComboBox<>();
        ...
        cboDeparts.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Công nghệ thông tin", "Quản trị kinh doanh", "Tài chính - Ngân hàng", "Y dược", "Sư phạm", "Cơ khí - Chế tạo máy", "Xây dựng", "Du lịch - Nhà hàng - Khách sạn", "Ngôn ngữ học", "Thiết kế - Mỹ thuật" }));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(cboDeparts, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cboDeparts, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel6)
                    .addComponent(jLabel5)
    ...
    private javax.swing.JComboBox<String> cboDeparts;
